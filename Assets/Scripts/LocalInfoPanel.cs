...
public class LocalInfoPanel : MonoBehaviour
{
    ...
    [SerializeField] TMP_Text yearTMP;
    ...
    void Update()
    {
        ...
        yearTMP.text = "Year: " + time.GetYear() + "BP";
        dayTMP.text = "Day: " + time.GetDay();
        hourTMP.text = "Hour: " + time.GetHour();
    }
}
